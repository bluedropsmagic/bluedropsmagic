...
export const AdminDashboard: React.FC = () => {
  ...
  const handleClearDashboard = async () => {
    ...
    try {
      ...
      alert('✅ Dashboard limpo com sucesso! Todos os dados foram removidos.');
      
    } catch (error) {
      console.error('❌ Error clearing dashboard:', error);
      alert('❌ Erro ao limpar dashboard: ' + (error as Error).message);
    } finally {
      setIsClearing(false);
    }
  };
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="bg-gray-600 hover:bg-gray-700 text-white px-3 sm:px-4 py-2 rounded-lg flex items-center gap-2 transition-colors text-sm"
                  >
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-md">
            <div className="text-center mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-900 mb-2">
                Limpar Dashboard Inteiro?
              </h2>
              <p className="text-gray-600">
                Esta ação irá <strong>deletar TODOS os dados</strong> do dashboard permanentemente. 
                Isso inclui todas as sessões, eventos, analytics e estatísticas.
              </p>
            </div>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              ...
              <ul className="text-sm text-red-700 space-y-1">
                <li>• Todas as sessões serão removidas</li>
                <li>• Todos os eventos de tracking serão perdidos</li>
                <li>• Estatísticas e gráficos serão zerados</li>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={isClearing}
                className="flex-1 bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isClearing ? (
                  <>
                    <RefreshCw className="w-4 h-4 animate-spin" />
