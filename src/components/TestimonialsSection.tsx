  ...
  useEffect(() => {
    if (isActive) {
      ...
      const injectTestimonialVideo = () => {
        const isMainVideoLoaded = window.vslVideoLoaded;
        ...
        if (pageType === 'main' && !window.vslVideoLoaded) {
          ...
          // For upsell pages, wait a bit longer to avoid conflicts
              ...
              s.onload = function() {
                ...
                setTimeout(function() {
                  ...
                  if (mainVideoContainer && testimonialContainer) {
                    ...
                    var mainVideoElements = testimonialContainer.querySelectorAll('[src*="68bf9911b38480b5c834d7fa"], [data-video-id="68bf9911b38480b5c834d7fa"]');
