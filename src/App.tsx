...
function App() {
  ...
  useEffect(() => {
    ...
    const injectVTurbScript = () => {
      ...
      const mainContainer = document.getElementById('vid-68ad36221f16ad3567243834');
      if (!mainContainer) {
      ...
      script.innerHTML = `
        (function() {
          try {
            ...
            var targetContainer = document.getElementById('vid-68ad36221f16ad3567243834');
            if (!targetContainer) {
            ...
            s.onload = function() {
              ...
              var container = document.getElementById('vid-68ad36221f16ad3567243834');
              if (!container) {
              ...
              setTimeout(function() {
                try {
                  ...
                  var videoElements = document.querySelectorAll('#vid-68ad36221f16ad3567243834 video');
              ...
              setTimeout(function() {
                var mainContainer = document.getElementById('vid-68ad36221f16ad3567243834');
                if (mainContainer) {
                  ...
                  videoElements.forEach(function(element) {
                    ...
                    if (elementContainer && elementContainer.id !== 'vid-68ad36221f16ad3567243834') {
  ...
  const setupVideoTracking = () => {
    ...
    const checkForPlayer = () => {
      try {
        ...
        if (!playerContainer) {
          console.error('❌ MAIN video container not found (vid-68ad36221f16ad3567243834)');
