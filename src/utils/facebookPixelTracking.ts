...
export const trackInitiateCheckout = (url?: string): void => {
  ...
  try {
    ...
    // ✅ NOTE: Utmify tracking is now handled automatically via checkout-button class detection
    // The pixel script in index.html will automatically track InitiateCheckout when checkout buttons are clicked
