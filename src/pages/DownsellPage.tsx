...
export const DownsellPage: React.FC<DownsellPageProps> = ({ variant }) => {
  ...
  useEffect(() => {
    console.log('🎬 Injecting VTurb for downsell video: 687c72f603cd186056ea5d15');
    
    // Remove existing script if any
    const existingScript = document.getElementById('scr_687c72f603cd186056ea5d15');
    if (existingScript) {
      existingScript.remove();
    }

    // Create the video container content
    const playerContainer = document.getElementById('downsell-video-container');
    if (playerContainer) {
      playerContainer.innerHTML = `
        <vturb-smartplayer 
          id="vid-687c72f603cd186056ea5d15" 
      ...
      script.id = 'scr_687c72f603cd186056ea5d15';
      script.async = true;
      script.innerHTML = `
        (function() {
          try {
            console.log('🎬 Loading downsell VTurb video: 687c72f603cd186056ea5d15');
            var s = document.createElement("script");
            s.src = "https://scripts.converteai.net/b792ccfe-b151-4538-84c6-42bb48a19ba4/players/687c72f603cd186056ea5d15/v4/player.js";
            s.async = true;
            s.onload = function() {
              console.log('✅ Downsell VTurb video loaded: 687c72f603cd186056ea5d15');
            };
            s.onerror = function() {
              console.error('❌ Failed to load downsell VTurb video: 687c72f603cd186056ea5d15');
            };
    ...
    // Cleanup on unmount
    return () => {
      const scriptToRemove = document.getElementById('scr_687c72f603cd186056ea5d15');
      if (scriptToRemove) {
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="mb-6 text-center animate-fadeInUp animation-delay-400">
            ...
            <p className="text-sm sm:text-base text-blue-800 font-semibold px-2 mb-6">
              Watch this important message about your treatment success.
            </p>
          </div>
          ...
          {/* Never Again Warning */}
          <section className="text-center mb-6 animate-fadeInUp animation-delay-1150">
          ...
          {/* Main Offer */}
          <div className="mb-6 relative animate-fadeInUp animation-delay-1250">
            {/* TODAY ONLY Tag */}
          ...
          <section className="text-center mb-6 animate-fadeInUp animation-delay-1350">
            <div className="bg-white/30 backdrop-blur-sm rounded-2xl p-4 border border-blue-200">
              <p className="text-blue-800 text-sm sm:text-base">
