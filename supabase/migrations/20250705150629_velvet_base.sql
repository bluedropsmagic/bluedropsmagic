/*
  # Complete safe migration with all necessary components

  This migration ensures all database objects are created safely with
  proper IF NOT EXISTS / IF EXISTS clauses and conditional logic.

  1. Tables
    - Ensure vsl_analytics table exists with all columns
  
  2. Security
    - Enable RLS safely
    - Create policies with safe removal/creation
  
  3. Performance
    - Create all necessary indexes safely
  
  4. Constraints
    - Add check constraints with conditional logic
